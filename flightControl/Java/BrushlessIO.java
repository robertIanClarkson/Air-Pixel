...
public class BrushlessIO{
	...
	long freq = 1060.0 / ( 1000000.0 / 4096.0 / 60.0 );
        // set the PWM rate to Init
        pwm.setPwm(freq.intValue());
        console.println("PWM rate is: " + pwm.getPwm());

        console.println("Press ENTER to set the PWM to a rate of 250");
        System.console().readLine();

        // set the PWM rate to Low
        pwm.setPwm(toIntExact(1200.0 / 1000000.0 / 4096.0 / 60.0));
        console.println("PWM rate is: " + pwm.getPwm());
