...
Utils.buffToXYZAccel= function(buffer){
    var pos;
    pos = {
        x: this.trueRound( this.twoscomp(((buffer[1] << 8) | buffer[0]) >> 4,12) * 0.001 , 3 ),
        y: this.trueRound( this.twoscomp(((buffer[3] << 8) | buffer[2]) >> 4,12) * 0.001 , 3 ),
        z: this.trueRound( this.twoscomp(((buffer[5] << 8) | buffer[4]) >> 4,12) * 0.001 , 3 ) 
    };
